...
async function loadThemeGallery() {
  try {
    ...
    themes.forEach((theme, idx) => {
      ...
      const layoutLabels = {
        standard:"Standard", two_column:"2-Col", classic:"Classic", minimal:"Minimal",
        modern_bold:"Modern", traditional:"Traditional", minimalist:"Minimalist",
        creative:"Creative", professional:"Professional", executive:"Executive",
        academic:"Academic CV", entry_level:"Entry Level", functional:"Functional", technical:"Technical"
      };
      const layoutLabel = layoutLabels[theme.layout] || theme.layout;

      // Category tag for the 10 new types
      const categoryTags = {
        modern_bold:"Tech / Startup", traditional_classic:"Law / Finance",
        minimalist_clean:"Engineering", creative_vivid:"Design / Arts",
        professional_navy:"Corporate / HR", executive_elite:"C-Suite / Director",
        academic_cv:"Academic / Research", entry_level_fresh:"Student / Fresher",
        functional_skill:"Career Change", technical_grid:"IT / Developer"
      };
      const catTag = categoryTags[theme.id] ? `<span class="template-cat-tag">${categoryTags[theme.id]}</span>` : "";
